# USAGE
# python F:/HK4/AI/Project_Style_Transfer/neural-style-transfer/neural_style_transfer_video.py
...
root = tk.Tk()
root.title("Artificial Intelligence v0.1 Real-time Video")
...
def transfer():
	...
	net = cv2.dnn.readNetFromTorch(root.stylename)
...
"""
# USAGE
# python F:/HK4/AI/Project_Style_Transfer/neural-style-transfer/neural_style_transfer_video.py --model F:/HK4/AI/Project_Style_Transfer/neural-style-transfer/models
